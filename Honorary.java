...
public class Honorary {
	...
	@Test
	public void testHonorary() throws Exception {
		...
		driver.findElement(By.linkText("Costs")).click();
		driver.findElement(By.linkText("Honorary")).click();

		List<List<HSSFCell>> data = selectSheet.getSheetData(4);
